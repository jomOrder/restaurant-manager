...
const CreateChooseItem = forwardRef(({ onSubmit, closeModal }, ref) => {
    ...
    return (
        <div>
            <div className="card" >
                <div className="card-header text-center"><span className="splash-description" style={{ textAlign: "left", fontSize: "1.2rem" }}>Create Choose Item</span></div>
                <div className="card-body" style={{ padding: "2.25rem" }}>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="form-group">
                            <input className={"form-control form-control-lg " + (errors.name ? 'is-invalid' : values.isValid)} id="name" ref={register({ required: true })} type="text" name="name" placeholder="Choose Name" autoComplete="off" />
...
export default CreateChooseItem;